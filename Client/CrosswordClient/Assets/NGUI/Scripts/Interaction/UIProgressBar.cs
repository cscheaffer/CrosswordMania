...
public class UIProgressBar : UIWidgetContainer
{
    ...
    protected bool allowFractionalUpdates = false;

    public void SetAllowFractionalUpdates(bool val)
    {
        allowFractionalUpdates = val;
    }
	...
	public float value
	{
		get
		{
			if (numberOfSteps > 1 && !allowFractionalUpdates)
            {
                return Mathf.Round(mValue * (numberOfSteps - 1)) / (numberOfSteps - 1);
            }
			return mValue;
		}
		set
