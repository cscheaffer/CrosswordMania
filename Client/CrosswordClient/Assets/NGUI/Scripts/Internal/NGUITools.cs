...
//    }
	...
	static public void SetDirty (UnityEngine.Object obj)
	{
		...
		if (obj)
		{
			//if (obj is Component) SceneController.LogService.Log(LogLevel.Information,NGUITools.GetHierarchy((obj as Component).gameObject), obj, this);
			//else if (obj is GameObject) SceneController.LogService.Log(LogLevel.Information,NGUITools.GetHierarchy(obj as GameObject), obj, this);
			//else SceneController.LogService.Log(LogLevel.Information,"Hmm... " + obj.GetType(), obj, this);
