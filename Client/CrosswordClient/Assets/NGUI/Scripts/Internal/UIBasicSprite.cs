...
public abstract class UIBasicSprite : UIWidget
{
	...
	virtual public float fillAmount
	{
		get
		{
			return mFillAmount;
...
#region Fill Functions
	...
	void FilledFill (BetterList<Vector3> verts, BetterList<Vector2> uvs, BetterList<Color32> cols)
	{
        ...
        if (mFillDirection == FillDirection.Radial360 && mFillAmount >= 1.0f)
        {
            verts.buffer = null;
            uvs.buffer = null;
            cols.buffer = null;
            ...
            //uvs.Clear();
            //cols.Clear();          
            //SceneController.LogService.Log(LogLevel.Information,"FillAmount: " + mFillAmount, this);
            return;
        }
        Vector4 v = drawingDimensions;
		Vector4 u = drawingUVs;
