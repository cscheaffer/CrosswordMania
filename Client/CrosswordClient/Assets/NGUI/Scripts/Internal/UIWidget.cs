...
public class UIWidget : UIRect
{
	...
	public bool ShowWidgetDebugs = false;

	public static bool ShowLayerError = false;
	...
	public void CheckLayer ()
	{
		...
		{
			if (ShowLayerError) Debug.LogWarning("You can't place widgets on a layer different than the UIPanel that manages them.\n" +
	...
	protected virtual void OnDestroy () { RemoveFromPanel(); }
		...
		if (mChanged)
		{
			...
			if (mIsVisibleByAlpha && finalAlpha > 0.001f && shader != null)
			{
				...
				if (geometry.hasVertices)
				{
					...
					//SceneController.LogService.Log(LogLevel.Information,"Fill " + name + " (" + Time.frameCount + ")", this);
