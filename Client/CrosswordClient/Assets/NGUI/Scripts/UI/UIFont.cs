...
public class UIFont : MonoBehaviour
{
	...
	public Material material
	{
		get
		{
		    ...
		    if (mAtlas != null)
		    {
                //jwu - this code is used to fix a ref atlas that has had the link broken by loading 
                //the UILabel using the UIFont from an asset bundle.
                if (mAtlas != null && mAtlas.name.Contains("RefAtlas") && mAtlas.spriteMaterial == null)
                    mAtlas.FixUpAtlas();
	...
	public bool premultipliedAlphaShader
	{
		get
		{
		    ...
		    if (mAtlas != null)
		    {
                //jwu - this code is used to fix a ref atlas that has had the link broken by loading 
                //the UILabel using the UIFont from an asset bundle.
                if (mAtlas.name.Contains("RefAtlas"))
                    mAtlas.FixUpAtlas();
	...
	public UISpriteData sprite
	{
		get
		{
            ...
            //jwu - adding this code and removing the below section
		    if (!string.IsNullOrEmpty(mFont.spriteName))
		    {
                ...
                //jwu - this code is used to fix a ref atlas that has had the link broken by loading 
                //the UILabel using the UIFont from an asset bundle.
		        if (mSprite == null && mAtlas != null && mAtlas.name.Contains("RefAtlas"))
		        {
		            mAtlas.FixUpAtlas();
		    ...
		    //jwu - removing this because its nulling out the spriteName when using the RefAtlas
            /*
