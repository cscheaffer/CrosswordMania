...
public class UILabel : UIWidget
{
	...
	public virtual UIFont bitmapFont
	{
		get
		{
			return mFont;
	...
	public virtual Font trueTypeFont
	{
		get
		{
    ...
    public virtual void SetWidth(int setWidth)
    {   
    }

    public virtual void SetHeight(int setHeight)
    {
    }

    public virtual void SetDepth(int setDepth)
    {
    }

    public virtual void SetSpacingX(int setSpacingX)
    {
    }

    public virtual void SetSpacingY(int setSpacingY)
    {
    }
}
